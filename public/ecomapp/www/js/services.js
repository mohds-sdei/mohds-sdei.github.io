...
.factory('login',function ($resource) {
   return $resource('http://localhost:3000/admin/login'); 
})
.factory('logout',function ($resource) {
   return $resource('http://localhost:3000/admin/logout'); 
})
.factory('isAuthenticated',function ($resource) {
   return $resource('http://localhost:3000/admin/checkSession'); 
})
.factory('users',function ($resource) {
   return $resource('http://localhost:3000/admin/manageUsers/:id', { id: '@_id' }); 
})
.factory('products',function ($resource) {
   return $resource('http://localhost:3000/admin/addProduct/:id', { id: '@_id' }); 
})
